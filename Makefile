...
bin/ana: src/main.cc lib/resonance.o lib/born.o lib/manager.o
	$(CC) $(ROOTLIBS) $(ROOTFLAGS) $(DEBUG) -lMathMore src/main.cc lib/resonance.o lib/born.o lib/manager.o -o bin/ana
